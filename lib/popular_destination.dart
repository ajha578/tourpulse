          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  cityName,
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black), // Dark city name
                ),
                Opacity(
                  opacity: 0.6, // Make the country name slightly transparent
                  child: Text(
                    countryName,
                    style: TextStyle(fontSize: 16, color: Colors.black), // Dark color for the country name
                  ),
                ),
              ],
            ),
